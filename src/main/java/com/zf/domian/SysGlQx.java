...
public class SysGlQx {
    ...
    @Id
    @Column(name = "GL_ID", nullable = false, insertable = true, updatable = true, length = 100)
    ...
    @Basic
    @Column(name = "FX_QX", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "FW_QX", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "QX1", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "QX2", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "QX3", nullable = true, insertable = true, updatable = true)
    ...
    @Basic
    @Column(name = "QX4", nullable = true, insertable = true, updatable = true)
